...
import { deleteTeacherAccessibleSubmission } from '@/app/actions/submission.actions';
import { Loader2, Trash2 } from 'lucide-react';

export function DeleteTeacherSubmissionButton({
  id,
  redirectTo,
  className,
}: {
  ...
  return (
    <button
      ...
      onClick={async (e) => {
        ...
        setLoading(true);
        try {
          await deleteTeacherAccessibleSubmission(id);
