...
/**
 * Shared site footer - dùng chung cho Landing Page và các trang con.
 * Giữ nguyên style y hệt Landing Page footer.
 */
      ...
      <div className="mx-auto w-full max-w-[1440px] px-4 lg:px-[120px]">
        ...
        <div className="mt-6 flex flex-col gap-6 lg:flex-row lg:items-start lg:justify-between">
          <div className="flex flex-wrap gap-6 text-[18px] text-[#3d3d3d]">
            ...
            <a href="/goc-hoc-vien" className="hover:text-[#f05e23]">
              Góc học viên
            </a>
          </div>
